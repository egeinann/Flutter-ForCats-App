...
class _TravelerHomeScreenState extends State<TravelerHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        return false; // WillPopScope geri tuşuna basınca geri gitmeyi engeller
      },
      child: Scaffold(
        ...
        body: SafeArea(
          child: Stack(
            children: [
              ...
              Align(
                ...
                child: Image(
                    ...
                    image: const AssetImage(
                        "assets/pictures/3Dcat_homescreen.png"),
              ...
              Align(
                ...
                child: Listener(
                  onPointerUp: (_) => setState(() {
                    ...
                    Navigator.pushNamed(
                        context, "/go_main_screen"); // önceki sayfaya geri dön
                  }),
              ...
              // ZİRVEDEKİ SAYFANIN İSMİNİ BELİRTEN TEXT
              Align(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image(
                              image: AssetImage(
                                  "assets/pictures/UYGULAMALOGO.png"),
