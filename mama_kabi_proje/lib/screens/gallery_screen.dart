            ...
            Align(
              ...
              child: Image(
                width: MediaQuery.of(context).size.width*0.5,
                  image: const AssetImage("assets/pictures/3Dcat_galleryscreen.png"),
                  centerSlice: Rect.largest),
            ),
            Align(
              alignment: Alignment.topCenter,
              child: Text("Pati Albümünüz",style: useMyFont(MediaQuery.of(context).size.width*0.06, MyColors.myDarkBlue_1),),
            )
          ],
        ),
      ),
